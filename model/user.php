...
class UserModel extends Model{
   ...
   * @return array
   */
  function charaList($uid){
    $sql = sprintf('SELECT DISTINCT chara_id FROM UserChara WHERE user_id = :userid', $this->tableName);
    $bind = [ ['name'=>':userid',  'value'=>$uid,     'type'=>PDO::PARAM_INT] ];
    $this->query($sql, $bind);
